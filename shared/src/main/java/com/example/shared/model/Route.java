...
public class Route {
    ...
    static {
        ...
        ROUTE_GROUP_MAP.put(2, new Route(2, new City("San Francisco"), new City("Salt Lake City"), RouteColor.WHITE, 10, 5));
        ROUTE_GROUP_MAP.put(3, new Route(3, new City("San Francisco"), new City("Portland"), RouteColor.GREEN, 10, 5));
        ROUTE_GROUP_MAP.put(4, new Route(4, new City("Portland"), new City("Seattle"), RouteColor.GRAY, 1, 1));
        ...
        ROUTE_GROUP_MAP.put(7, new Route(7, new City("Portland"), new City("Seattle"), RouteColor.GRAY, 1, 1));
        ROUTE_GROUP_MAP.put(8, new Route(8, new City("Seattle"), new City("Vancouver"), RouteColor.GRAY, 1, 1));
        ROUTE_GROUP_MAP.put(9, new Route(9, new City("Seattle"), new City("Vancouver"), RouteColor.GRAY, 1, 1));
        ROUTE_GROUP_MAP.put(10, new Route(10, new City("Los Angeles"), new City("San Francisco"), RouteColor.YELLOW, 4, 3));
        ROUTE_GROUP_MAP.put(11, new Route(11, new City("Los Angeles"), new City("San Francisco"), RouteColor.PINK, 4, 3));
        ROUTE_GROUP_MAP.put(12, new Route(12, new City("Las Vegas"), new City("Salt Lake City"), RouteColor.ORANGE, 4, 3));
        ROUTE_GROUP_MAP.put(13, new Route(13, new City("San Francisco"), new City("Salt Lake City"), RouteColor.ORANGE, 10, 5));
        ROUTE_GROUP_MAP.put(14, new Route(14, new City("San Francisco"), new City("Portland"), RouteColor.PINK, 10, 5));
        ...
        ROUTE_GROUP_MAP.put(20, new Route(20, new City("Salt Lake City"), new City("Denver"), RouteColor.RED, 4, 3));
        ROUTE_GROUP_MAP.put(21, new Route(21, new City("Salt Lake City"), new City("Denver"), RouteColor.YELLOW, 4, 3));
        ...
        ROUTE_GROUP_MAP.put(36, new Route(36, new City("Denver"), new City("Kansas City"), RouteColor.ORANGE, 7, 4));
        ROUTE_GROUP_MAP.put(37, new Route(37, new City("Denver"), new City("Kansas City"), RouteColor.BLACK, 7, 4));
        ...
        ROUTE_GROUP_MAP.put(44, new Route(44, new City("Duluth"), new City("Omaha"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(45, new Route(45, new City("Duluth"), new City("Omaha"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(46, new Route(46, new City("Omaha"), new City("Kansas City"), RouteColor.GRAY, 1, 1));
        ROUTE_GROUP_MAP.put(47, new Route(47, new City("Omaha"), new City("Kansas City"), RouteColor.GRAY, 1, 1));
        ROUTE_GROUP_MAP.put(48, new Route(48, new City("Kansas City"), new City("Oklahoma City"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(49, new Route(49, new City("Kansas City"), new City("Oklahoma City"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(50, new Route(50, new City("Oklahoma City"), new City("Dallas"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(51, new Route(51, new City("Oklahoma City"), new City("Dallas"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(52, new Route(52, new City("Dallas"), new City("Houston"), RouteColor.GRAY, 1, 1));
        ROUTE_GROUP_MAP.put(53, new Route(53, new City("Dallas"), new City("Houston"), RouteColor.GRAY, 1, 1));
        ...
        ROUTE_GROUP_MAP.put(57, new Route(57, new City("Kansas City"), new City("Saint Louis"), RouteColor.BLUE, 2, 2));
        ROUTE_GROUP_MAP.put(58, new Route(58, new City("Kansas City"), new City("Saint Louis"), RouteColor.PINK, 2, 2));
        ...
        ROUTE_GROUP_MAP.put(66, new Route(66, new City("Saint Louis"), new City("Chicago"), RouteColor.WHITE, 2, 2));
        ROUTE_GROUP_MAP.put(67, new Route(67, new City("Saint Louis"), new City("Chicago"), RouteColor.GREEN, 2, 2));
        ROUTE_GROUP_MAP.put(68, new Route(68, new City("New Orleans"), new City("Atlanta"), RouteColor.YELLOW, 7, 4));
        ROUTE_GROUP_MAP.put(69, new Route(69, new City("New Orleans"), new City("Atlanta"), RouteColor.ORANGE, 7, 4));
        ...
        ROUTE_GROUP_MAP.put(72, new Route(72, new City("Pittsburgh"), new City("Washinton"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(73, new Route(73, new City("New York"), new City("Washington"), RouteColor.ORANGE, 2, 2));
        ROUTE_GROUP_MAP.put(74, new Route(74, new City("New York"), new City("Washington"), RouteColor.BLACK, 2, 2));
        ROUTE_GROUP_MAP.put(75, new Route(75, new City("Montreal"), new City("New York"), RouteColor.BLUE, 4, 3));
        ROUTE_GROUP_MAP.put(76, new Route(76, new City("Montreal"), new City("Boston"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(77, new Route(77, new City("Montreal"), new City("Boston"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(78, new Route(78, new City("Pittsburgh"), new City("New York"), RouteColor.GREEN, 2, 2));
        ROUTE_GROUP_MAP.put(79, new Route(79, new City("Raleigh"), new City("Washington"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(80, new Route(80, new City("Atlanta"), new City("Raleigh"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(81, new Route(81, new City("Atlanta"), new City("Raleigh"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(82, new Route(82, new City("Raleigh"), new City("Washington"), RouteColor.GRAY, 2, 2));
        ROUTE_GROUP_MAP.put(83, new Route(83, new City("Pittsburgh"), new City("New York"), RouteColor.WHITE, 2, 2));
        ...
        ROUTE_GROUP_MAP.put(86, new Route(86, new City("Chicago"), new City("Pittsburgh"), RouteColor.BLACK, 4, 3));
        ...
        ROUTE_GROUP_MAP.put(96, new Route(96, new City("Chicago"), new City("Pittsburgh"), RouteColor.ORANGE, 4, 3));
        ROUTE_GROUP_MAP.put(97, new Route(97, new City("Boston"), new City("New York"), RouteColor.RED, 2, 2));
        ROUTE_GROUP_MAP.put(98, new Route(98, new City("Boston"), new City("New York"), RouteColor.YELLOW, 2, 2));
